    ...
    static void memberEntry(String firstName, String lastName, String mobileNumber, String gender, String mail, String password, String member) throws PSNullException, SQLException {
        ...
        try
        {
            ...
            else
			{
				...
				String query = "INSERT INTO user_details VALUES ('" + firstName + "','" + lastName + "'," + mobileNumber
						+ ",'" + gender + "','" + mail + "','" + PasswordHash.getEncryptedPassword(password) + "',"
						+ UserCreation.failCount + "," + UserCreation.isAccountStatus() + "," + favouriteNumber + ")";
				preparedStatement = connection.prepareStatement(query);
